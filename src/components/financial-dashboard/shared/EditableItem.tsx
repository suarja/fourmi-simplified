      ...
      <div className="flex items-center justify-between gap-3">
        ...
        {canDelete && onDelete && (
          <button
            ...
            disabled={isLoading}
            className="opacity-0 group-hover:opacity-100 p-2 rounded-lg hover:bg-financial-danger/20 text-financial-danger hover:text-red-300 transition-all duration-200 flex-shrink-0"
            title="Delete item"
          >
